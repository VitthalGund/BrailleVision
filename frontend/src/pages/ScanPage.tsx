...
export function ScanPage() {
  ...
  return (
    <div className="flex-1 flex flex-col md:flex-row gap-6 p-4 md:p-6 pb-20 md:pb-6 overflow-hidden min-h-0 bg-slate-950 text-slate-100">
      ...
      <div className="flex-1 flex flex-col gap-6 overflow-y-auto pr-0 md:pr-2">
        <div className="flex flex-col gap-2">
          <h2 className="text-xl md:text-2xl font-bold tracking-tight text-slate-100">Braille Scan Reader</h2>
